...
class Woocommerce_Dynamic_Pricing_And_Discount_Pro_Admin {
    ...
    public function wdpad_dot_store_menu_conditional() {
        ...
        add_submenu_page(
            ...
            'Import / Export',
            'manage_options',
            'wcdrfc-page-import-export',
            array($this, 'wdpad_import_export_discount')
        );
        if ( !(wcdrfc_fs()->is__premium_only() && wcdrfc_fs()->can_use_premium_code()) ) {
            add_submenu_page(
                'dots_store',
     ...
     * @since    2.3.3
     */
    public function wdpad_import_export_discount() {
        require_once plugin_dir_path( __FILE__ ) . '/partials/wcdrfc-import-export-setting.php';
    }
